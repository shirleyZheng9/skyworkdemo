...
import com.iwhalecloud.bote.dto.plugin.params.LarkUpdateRecordsPluginParams;
import com.iwhalecloud.bote.dto.plugin.params.LarkUpdateRecordsPluginParams.RecordDTO;
 ...
 */
@Component
public class LarkUpdateRecordsPlugin extends AbstractLarkPlugin<LarkUpdateRecordsPluginParams> {
  /** 批量更新记录 url */
  private static final String ADD_RECORDS_URL = "https://open.feishu.cn/open-apis/bitable/v1/apps/:appToken/tables/:tableId/records/batch_update";

  public LarkUpdateRecordsPlugin() {
    super(LarkUpdateRecordsPluginParams.class);
  }

  @Override
  public String getPluginCode() {
    return PluginConsts.PLUGIN_CODE_LARK_UPDATE_RECORDS;
  }
  ...
  public ParameterSpec createRequestParameter() {
    ...
    children.add(ParameterSpec.newList("records", "记录列表",
      ParameterSpec.newObject("record", "记录", Arrays.asList(
        ParameterSpec.newProperty("fields", "字段", AttrDataType.STRING),
  ...
  @Override
  public void validateParams(LarkUpdateRecordsPluginParams params) {
  ...
  @Override
  public Object doRun(LarkUpdateRecordsPluginParams pluginParams) {
    return executeLarkApiCall(headers -> {
      ...
      request.put("records", snakeCaseMapper.convertValue(records, new TypeReference<List<Map<String, Object>>>() {
      }));
      return HttpUtil.post(url, request, new ParameterizedTypeReference<Map<String, Object>>() {
      }, headers);
    }, pluginParams, new TypeReference<LarkResultDTO<UpdateRecordResultDTO>>() {
    });
  }
  ...
  @Setter
  @ToString
  public static final class UpdateRecordResultDTO {
    /** 记录字段 */
  ...
  @Setter
  @ToString
  public static final class UpdateRecordDTO {
    /** 记录字段 */
