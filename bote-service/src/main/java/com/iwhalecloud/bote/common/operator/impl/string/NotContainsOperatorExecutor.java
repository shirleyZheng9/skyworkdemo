 ...
 * @since 2024-08-30
 */
public class NotContainsOperatorExecutor extends AbstractBinaryOperatorExecutor {
  @Override
  protected boolean executeBinary(@Nullable Object left, @Nullable Object right) {
    return !Strings.CS.contains(Objects.toString(left, null), Objects.toString(right, null));
  }
}
