...
@Setter
@ToString
@Schema(description = "文档库权限设置请求")
public class LibraryPermissionRequestDTO extends TenantBaseRO {
  ...
  private LibraryPermissionDataDTO data;

  @Getter
  @Setter
  @ToString
  @Schema(description = "文档库权限数据")
  public static class LibraryPermissionDataDTO {
