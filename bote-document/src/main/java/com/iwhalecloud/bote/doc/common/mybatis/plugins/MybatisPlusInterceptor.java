 ...
 */
package com.iwhalecloud.bote.doc.common.mybatis.plugins;

import com.iwhalecloud.bote.doc.common.mybatis.plugins.inner.InnerInterceptor;
...
public class MybatisPlusInterceptor implements Interceptor {
  ...
  public Object intercept(Invocation invocation) throws Throwable {
    ...
    if (target instanceof Executor) {
      ...
      if (!isUpdate && ms.getSqlCommandType() == SqlCommandType.SELECT) {
        return interceptForSelect(args, ms, parameter, executor);
      }
      else if (isUpdate) {
      ...
      processForStatementHandler(target, args);
    }
    return invocation.proceed();
  }

  private void processForStatementHandler(Object target, Object[] args) {
    // StatementHandler
    ...
    if (null == args) {
      ...
      Connection connections = (Connection) args[0]; //NOPMD - suppressed CloseResource - 不能关闭
  ...
  private List<Object> interceptForSelect(Object[] args,
                                          MappedStatement ms,
                                          Object parameter,
