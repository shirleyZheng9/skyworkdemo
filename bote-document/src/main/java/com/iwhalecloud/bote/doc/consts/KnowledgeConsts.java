...
public final class KnowledgeConsts {
  /** 知识库类型: 默认 */
  public static final String KNOWLEDGE_TYPE_DEFAULT = "rag";
  /** 知识库类型: DocChain */
  ...
  /** 知识库类型列表 */
  public static final List<String> KNOWLEDGE_TYPES = ImmutableList.of(KNOWLEDGE_TYPE_DEFAULT, KNOWLEDGE_TYPE_DOC_CHAIN, KNOWLEDGE_TYPE_PLATFORM, KNOWLEDGE_TYPE_BEYOND);
  /** 第三方知识库类型列表 */
  ...
  /** 关键字类型: 实体 */
  public static final String KEYWORD_TYPE_ENTITY = "10A";
  /** 关键字类型: 维度 */
  public static final String KEYWORD_TYPE_DIMENSION = "10B";
  /** 关键字类型: 未识别 */
  public static final String KEYWORD_TYPE_UNRECOGNIZED = "10C";
  /** 知识库查询来源: 召回测试 */
  ...
  /** 文档发布后的延时等待时间（秒），用于确保数据同步完成 */
  public static final long DOCUMENT_RELEASED_DELAY_SECONDS = 13L;
