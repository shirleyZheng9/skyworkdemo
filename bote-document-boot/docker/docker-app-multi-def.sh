...
app=(
  ...
  "echo $(netstat -lpnt | grep -c -w 9080)"
...
collab_server=(
  ...
  "dist/main.js"
  # liveness check command
  "echo $(netstat -lpnt | grep -c -w 9300)"
  # liveness successful code
  "1"
  # readiness check command
  "curl -I -m 3 -o /dev/null -s -w %{http_code} http://127.0.0.1:9300/api/health/live"
  # readiness successful code
  "200"
)
