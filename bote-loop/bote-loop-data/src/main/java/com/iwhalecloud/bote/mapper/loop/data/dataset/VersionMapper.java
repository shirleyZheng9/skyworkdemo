...
public interface VersionMapper {
   ...
   * - 用途: 获取单个版本
   */
  DatasetVersionEntity getVersion(@Param("spaceId") Long spaceId, @Param("versionId") Long versionId);
   ...
   * - 用途: 批量获取版本
   */
  List<DatasetVersionEntity> mGetVersions(@Param("spaceId") Long spaceId, @Param("ids") List<Long> ids);
   ...
   * - 用途: 分页查询版本
   */
  Page<DatasetVersionEntity> listVersions(ListDatasetVersionsParams params, RowBounds rowBounds);
   ...
   * - 用途: 更新版本
   */
  void patchVersion(@Param("patch") DatasetVersionEntity patch, @Param("where") DatasetVersionEntity where);
}
