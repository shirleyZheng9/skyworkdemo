...
/**
 * 数据集版本结果
 * 迁移对应关系: Go语言GetDatasetVersion方法的返回值
 * - 功能: 数据集版本查询的结果对象
 * - 字段定义:
...
@AllArgsConstructor
@Builder
public class DatasetVersionResult {

  /**
   * 版本对象
   * 迁移对应关系: Go语言GetDatasetVersion返回的version
   */
  private EvaluationSetVersion version;

  /**
   * 数据集对象
   * 迁移对应关系: Go语言GetDatasetVersion返回的set
   */
